...
public class ActionController : ControllerBase
{
    ...
    [HttpPut]
    [HttpPost]
    public async Task<ActionResult<ActionDto>> Upsert(ActionUpsertDto actionDto)
    {
        return Ok(await _actionService.Upsert(actionDto.NodeId, actionDto.Id, actionDto.Name));
    }
