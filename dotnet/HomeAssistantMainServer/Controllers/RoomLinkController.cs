...
public class RoomLinkController : ControllerBase
{
    ...
    public RoomLinkController(ILogger<ActionParameterController> logger,
    ...
    [HttpGet]
    public async Task<ActionResult<IEnumerable<RoomLinkDto>>> Get(int startRoomId, int endRoomId, int? id)
    {
