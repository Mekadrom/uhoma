...
public class ActionParameterController : ControllerBase
{
    ...
    {
        return Ok(await _actionParameterService.Upsert(actionParameterDto.ActionId, actionParameterDto.Id, actionParameterDto.Name, actionParameterDto.DefaultValue));
    }
